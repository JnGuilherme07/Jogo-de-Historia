...
function frases(Frase) {
    let frases = {
        ...
        2: 'Esse inimigo é mais poderoso que o anterio voce deve derrota-lo para conseguir o balde de ouro',
        3: 'Esse inimigo é da rassa mais poderosa para o seu nivel um inimigo que não deve subestimar',
        4: 'esse vem de uma raça guerreira fique atento aos ataques dele ele',
    ...
    do {
        ...
        if (oqueFazer == 'Ataca') {
            if (AtaqueTes >= DefesaIni) {
                ...
                if (VidaIni <= 0) {
                    ...
                    Frases.innerText = 'Você acertou o ataque porem o inimigo continua Vivo'
                    await delay(2700); // aguarda 2,7 segundos
                }
            }
            else {
        ...
        // defender
            ...
            if (AtaqueIni >= DefesaTes) {
                ...
                Vida = Vida + 7
                vida.innerText = Vida
                Frases.innerText = `Você conseguiu, esquivou do ataque dele e recebeu ${7} de Vida `
                await delay(2700)
            }
        }
...
async function Jogar() {
    ...
    do {
        ...
        if (jogadorvivo == false) {
            ...
            if (Inimigo == 10) {
                Frases.innerText = 'Você derrotou o Salazar tome a seu pote de ouro !!!'
                delay(2700)
                venceuOjogo()
            }
        }
...
function venceuOjogo() {
    ...
    imagem.innerHTML = '<img id="ImagemPizza" src="imagenss/pixil-frame-0 (1).png" alt="Imagem Pizaz">'
